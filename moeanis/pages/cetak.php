...
<th class="column100 column4" data-column="column4"><b>Nama Barang</b></th>
<th class="column100 column5" data-column="column5"><b>Jumlah</b></th>
<th class="column100 column6" data-column="column6"><b>Harga</b></th>
</tr>
</thead>
<?php
include_once '../koneksi.php';
$query=mysqli_query($konek," SELECT * FROM catatan");
$total=0;
$totaluang=0;
$no=0;
...
<td class="column100 column4" data-column="column4"><?php echo $data['nama_barang']; ?></td>
<td class="column100 column5" data-column="column5"><?php echo $data['jumlah']; ?></td>
<td class="column100 column6" data-column="column6"><?php echo 'Rp.', number_format($uang);  ?></td>

</tr>
<?php } ?>
<tr class="row100">
<td class="column100 column1" colspan="4" data-column="column1">Total Pengeluaran</td>
<td class="column100 column3" data-column="column3"><?php echo 'Rp.', number_format($totaluang,2); ?></td>
</tr>

<tr class="row100">
<td class="column100 column1" colspan="4" data-column="column1">Sisa Uang</td>
	<?php
		include_once '../koneksi.php';
		$sql = mysqli_query($konek," SELECT * FROM keuangan where status='keluar' ");
		while($d = mysqli_fetch_assoc($sql)){?>
<td class="column100 column3" data-column="column3"><?php echo 'Rp.', number_format($d['uang'],2); } ?></td>
</tr>
